...
{"properties": {
    ...
    "dataset": {"properties": {
        ...
        "isotopic": {"type": "string"},
        "keywords": {"type": "string"},
        "location": {"properties": {"bbox": {"properties": {
    ...
    "model_vars": {"type": "string"},
    "parent_model_run_uuid": {"type": "string"},
